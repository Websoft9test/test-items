...
These accounts are required for Test image installation and configuration

## Test

* Test administrator username: `admin`
* Test administrator password: stored in the file of your server */credentials/password.txt*
